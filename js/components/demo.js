...
$(document).ready(function($){
    ...
    if ($('.nav-switch').length) {
        ...
        $('#nav-solid').on('click', function(){
            ...
            $('#demo-nav .navbar-brand img').attr("src","/assets/images/logos/kit-purple.svg");
        });
        ...
        $('.is-variation').on('click', function(){
            ...
            $('#demo-nav .navbar-brand img').attr("src","/assets/images/logos/kit-white.svg");
        });
    }
    ...
    $(window).on('scroll', function () {    // this will work when your window scrolled.
        ...
        if(height  > 80) {
            $("img.light-logo").attr("src","/assets/images/logos/om-logo.png");
        } else{
            $("img.light-logo").attr("src","/assets/images/logos/om-white-logo.png");
        }
    });
